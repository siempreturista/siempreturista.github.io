...
<body>
    ...
    <div class="container mx-auto p-4 md:p-8 max-w-4xl">
        ...
        <header class="text-center my-12">
            <h1 class="text-5xl md:text-6xl font-black accent-text">¡Siempre Turista!</h1>
            <p class="mt-4 text-xl md:text-2xl font-bold highlight-text">Desbloquea el asombro de tu ciudad</p>
        </header>
